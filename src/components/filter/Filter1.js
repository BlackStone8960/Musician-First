    ...
    <div className="filter-wrapper">
      <div className="filter1-container">
        ...
        <p className="filter1-discription">
          Is your music dangerous, sharp, and always standing out from the pack?
          Do you try to make a bold statement, and love to hear loud, exciting
          sounds? Rebels take heed, this is where rock, punk, metal, and the
          heavier side of music is found.
        </p>
      </div>
      <div className="filter1-container">
        <div className="button button--filter1">
        ...
        <p className="filter1-discription">
          ...
          where you would want your beautiful, vocal driven, emotion based music
          to soar and be found. Chill music can be found in genres such as folk,
          jazz, singersongwriter, and many, many more.
        </p>
      </div>
      <div className="filter1-container">
        <div className="button button--filter1">
      ...
      <div className="filter1-container">
        ...
        <p className="filter1-discription">
          ...
          desire to make something that really challenges the listener, whether
          it’s a 25 minute spoken word poem played on a midi saxophone, or
          something that you cooked up in that basement laboratory of yours.
        </p>
      </div>
    </div>
  </React.Fragment>
