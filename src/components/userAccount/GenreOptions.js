    ...
    <div className="input-block">
      ...
      <select id={id} value={genre} onChange={(e) => setGenre(e.target.value)}>
        ...
        <optgroup label="Edgy">
          ...
          <option disabled={currentOtherGenre === "Pop Rock"} value="Pop Rock">
            Pop Rock
          </option>
          <option
          ...
          <option disabled={currentOtherGenre === "Hardcore"} value="Hardcore">
            Hardcore
          </option>
          <option
        ...
        <optgroup label="Chill">
          ...
          <option disabled={currentOtherGenre === "Trip Hop"} value="Trip Hop">
            Trip Hop
          </option>
          <option
        ...
        <optgroup label="Dance">
          ...
          <option disabled={currentOtherGenre === "Dub Step"} value="Dub Step">
            Dub Step
          </option>
          <option disabled={currentOtherGenre === "Jazz"} value="Jazz">
            Jazz
        ...
        <optgroup label="Far Out">
          ...
          <option disabled={currentOtherGenre === "Art Rock"} value="Art Rock">
            Art Rock
          </option>
          <option
